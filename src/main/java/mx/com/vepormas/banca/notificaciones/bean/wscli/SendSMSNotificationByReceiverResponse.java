...
import mx.com.vepormas.banca.notificaciones.bean.wscli.base.Response;
...
@XmlType(name = "SendSMSNotificationByReceiverResponse", propOrder = {
	    "data"
	})
@XmlRootElement(name = "sendSMSNotificationByReceiverResponse", namespace = "http://vepormas.com/web/schemas/notifications")
public class SendSMSNotificationByReceiverResponse extends Response{
